...
const Form = ( {currentId, setCurrentId}) => {
  ...
  return (
    <Paper className ={classes.paper}>
      ...
      <Typography variant = 'h6'>{currentId ? 'Edit a post' : 'Create a post'}</Typography>
     ...
     <TextField name ="tags" vairant="outlined" label ="Tags (Comma seperated)" fullWidth value ={postData.tags} onChange={(e) => setPostData({ ...postData, tags: e.target.value.split(',')})} />
